...
CREATE TABLE "Booking" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'UAH',
    "commissionUSDCents" INTEGER NOT NULL DEFAULT 100,
    "paymentId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Ban_tutorId_active_idx" ON "Ban"("tutorId", "active");
...
-- AddForeignKey
ALTER TABLE "Ban" ADD CONSTRAINT "Ban_tutorId_fkey" FOREIGN KEY ("tutorId") REFERENCES "Tutor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
